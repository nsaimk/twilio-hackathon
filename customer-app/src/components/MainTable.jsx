...
const MainTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('https://twilio-hackathon-server.vercel.app/product');
    ...
    const handleBuy = async (productId) => {
        try {
            const response = await fetch(`https://twilio-hackathon-server.vercel.app/product/${productId}`, {
                method: 'PUT',
                headers: {
